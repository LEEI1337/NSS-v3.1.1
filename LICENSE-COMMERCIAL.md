...
- Companies using NSS in closed-source software
- SaaS providers
- Embedded/proprietary systems

| Tier | Company Size | Annual License | Support | SLA |
|------|-------------|---------------|---------|-----|
| **Startup** | < 50 employees | 5,000 EUR | 8x5 Email | 99.5% |
| **SMB** | 50-500 employees | 25,000 EUR | 24x7 Phone | 99.9% |
| **Enterprise** | > 500 employees | Custom | 24x7 Dedicated | 99.95% |

### What the Commercial License Includes

- Right to use NSS in proprietary/closed-source software
...
Copyright (C) 2026 Joerg Fuchs (LEEI1337). All rights reserved.
